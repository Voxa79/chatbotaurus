...
This repository also includes a modern React-based landing page for the IA Europa platform in the [landing](landing) directory. The landing page features:
...
To get started with the landing page, navigate to the [landing](landing) directory and follow the instructions in the [README](landing/README.md).
...
3. Set the following environment variables if deploying to production, otherwise leave commented:
   ...
   LANDING_HOSTNAME=yourdomain.com
...
7. Open <http://localhost:8002/> in your browser to set up Open WebUI.
...
## 🚀 **Services Access - Development Ports**

### 🎨 **Main Interfaces**
- **N8N Workflows**: <http://localhost:8001/>
- **Open WebUI Chat**: <http://localhost:8002/> 
- **Flowise Visual IA**: <http://localhost:8003/>
- **SearXNG Search**: <http://localhost:8006/>
- **Landing Hub Site**: <http://localhost:8012/>

### 📊 **Analytics & Monitoring**  
- **Langfuse LLM Analytics**: <http://localhost:8007/>
- **Neo4j Graph Browser**: <http://localhost:8008/>
- **MinIO S3 Console**: <http://localhost:8011/>
- **Supabase Analytics**: <http://localhost:4000/>

### 🔧 **APIs & Technical Services**
- **Ollama LLM API**: <http://localhost:8004/>
- **Qdrant Vector DB**: <http://localhost:8009/>
- **Supabase API Gateway**: <http://localhost:8000/>

> 📋 **Quick Reference**: See `PORTS-REFERENCE.md` for complete access guide with credentials.
